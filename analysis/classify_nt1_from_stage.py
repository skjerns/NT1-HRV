...
if True:
    ...
    for p in tqdm(ss, desc='Loading features'):
        ...
        for feat_name in cfg.mapping_feats:
            ...
            feats +=  [feat_median + feat_mean + feat_min + feat_max + feat_std]
    ...
    selector = RFECV(clf, cv=2, n_jobs=-1, verbose=100, step=10)
    ...
    plt.xticks(np.arange(15), feature_names_sorted[:15],rotation=70)
